...
We have all worked with data at some point of our work. Now, depending on the source, sometimes the data may not always be regular,
...
efficiently using a graphical way including many others useful data operation. 
Using Interactive Data Editor one can  
<ol>
    <li> Plot any 2D and gridded 3D data. </li>
    <li> Edit/Refine data including many useful data operations.</li>
    <li> Fit a function to the data.</li>
</ol>
<div class="blockd">
